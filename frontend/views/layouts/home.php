        ...
        <div id="content" class="col-sm-12">
            <div id="slideshow0" class="owl-carousel" style="opacity: 1;">
                <div class="item">
                    <a href="index.php?route=product/product&amp;path=57&amp;product_id=49"><img
                            src="http://static.yii-shop.dev/cache/banners/iPhone6-1140x380.jpg"
                            alt="iPhone 6" class="img-responsive"/></a>
                </div>
                <div class="item">
                    <img src="http://static.yii-shop.dev/cache/banners/MacBookAir-1140x380.jpg"
                    ...
                    <div class="product-thumb transition">
                        <div class="image"><a
                                href="http://localhost:8080/index.php?route=product/product&amp;product_id=43"><img
                                    src="http://static.yii-shop.dev/cache/products/macbook_1-200x200.jpg"
                    ...
                    <div class="product-thumb transition">
                        <div class="image"><a
                                href="http://localhost:8080/index.php?route=product/product&amp;product_id=40"><img
                                    src="http://static.yii-shop.dev/cache/products/iphone_1-200x200.jpg"
                    ...
                    <div class="product-thumb transition">
                        <div class="image"><a
                                href="http://localhost:8080/index.php?route=product/product&amp;product_id=42"><img
                                    src="http://static.yii-shop.dev/cache/products/apple_cinema_30-200x200.jpg"
                    ...
                    <div class="product-thumb transition">
                        <div class="image"><a
                                href="http://localhost:8080/index.php?route=product/product&amp;product_id=30"><img
                                    src="http://static.yii-shop.dev/cache/products/canon_eos_5d_1-200x200.jpg"
            ...
            <div id="carousel0" class="owl-carousel">
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/nfl-130x100.png" alt="NFL"
                         class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/redbull-130x100.png"
                         alt="RedBull" class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/sony-130x100.png" alt="Sony"
                         class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/cocacola-130x100.png"
                         alt="Coca Cola" class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/burgerking-130x100.png"
                         alt="Burger King" class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/canon-130x100.png" alt="Canon"
                         class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/harley-130x100.png"
                         alt="Harley Davidson" class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/dell-130x100.png" alt="Dell"
                         class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/disney-130x100.png"
                         alt="Disney" class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/starbucks-130x100.png"
                         alt="Starbucks" class="img-responsive"/>
                </div>
                <div class="item text-center">
                    <img src="http://static.yii-shop.dev/cache/manufacturers/nintendo-130x100.png"
